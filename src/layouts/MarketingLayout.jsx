      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.banner}>
          ...
          <div className={styles.bannerInfo}>
            ...
            <img src={illustration} alt="홍보 일러스트" className={styles.illustration} />
          </div>

          {/* 배너 오른쪽 이미지 버튼 그리드 영역 */}
          <div className={styles.buttonGrid}>
            <Link to="/cardnews">
              <img src={btnCardNews} alt="카드뉴스 생성" className={styles.imageButton} />
            </Link>
            <Link to="/map">
              <img src={btnMap} alt="지도 이용 제휴" className={styles.imageButton} />
            </Link>
            <Link to="/camera">
              <img src={btnPhoto} alt="사진 가이드" className={styles.imageButton} />
            </Link>
            <Link to="/main">
              <img src={btnMain} alt="메인 페이지" className={styles.imageButton} />
            </Link>
          </div>
          </div>
        </div>
        ...
        <div className={styles.partnershipBanner}>
          <div className={styles.bannerIllustrationContainer}>
            <img src={partnershipIllustration} alt="Partnership Illustration" className={styles.bannerIllustration} />
          </div>
            ...
            <div className={styles.partnerList}>
              ...
              <div className={styles.partnerCard}>
                ...
                <div className={styles.partnerButtons}>
                  <button className={`${styles.partnerButton} ${styles.acceptButton}`}>맺기</button>
                  <button className={`${styles.partnerButton} ${styles.declineButton}`}>거절</button>
                </div>
              </div>
              {/* 파트너 카드 2 */}
              <div className={styles.partnerCard}>
                <div className={styles.partnerInfo}>
                  ...
                  <p className={styles.partnerAddress}>구갈로60번길 19 금강프라자 102호</p>
                </div>
                <div className={styles.partnerButtons}>
                  <button className={`${styles.partnerButton} ${styles.acceptButton}`}>맺기</button>
                  <button className={`${styles.partnerButton} ${styles.declineButton}`}>거절</button>
              ...
              <div className={styles.partnerCard}>
                <div className={styles.partnerInfo}>
                  ...
                  <p className={styles.partnerAddress}>경기도 용인시 기흥구 기흥역로58번길 78 기흥역더샵오피스텔 201동 112호</p>
                </div>
                <div className={styles.partnerButtons}>
                  <button className={`${styles.partnerButton} ${styles.acceptButton}`}>맺기</button>
                  <button className={`${styles.partnerButton} ${styles.declineButton}`}>거절</button>
